...
export function CreateEventPage() {
  ...
  const ui = language === 'uk'
    ? {
        ...
        promoHint: 'Додайте коди зі знижкою для квитка. Покупець зможе застосувати їх перед переходом у Stripe Checkout.',
        promoCode: 'Промокод',
    ...
    : {
        ...
        promoHint: 'Add discount codes for this ticket. Buyers will be able to apply them before Stripe Checkout opens.',
